...
class FOORM {
     ...
     * 
     */
    function formSql($fieldinfo, $vendor) {
    ...
    function formSqlFields($formDefinition, $vendor) {
        $sb = '';
	...
	function formSqlTable($table, $formDefinition, $vendor, $doReset=false)  {
		$retval = Array();
    ...
    function formSqlKey($formDefinition) {
    ...
    function formSqlLKey($formDefinition) {
    ...
    function fieldsOfType($formDefinition, $kind) {
        $retval = Array();
        foreach ($formDefinition as $formField) {
    ...
    function formSqlLKeys($formDefinition, $vendor) {
        $retval = '';
        $txtlen = 0;
        $count = 0;
        foreach ($formDefinition as $formField) {
    ...
    function formSqlUniques($formDefinition, $vendor) {
        $retval = '';
        $txtlen = 0;
        $count = 0;
        foreach ($formDefinition as $formField) {
    ...
    function fieldsWithString($formDefinition, $string) {
        $retval = Array();
        foreach ($formDefinition as $formField) {
